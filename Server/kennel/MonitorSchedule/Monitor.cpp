#include "Monitor.h"
#include "svapi.h"
void WriteLog( const char* str );//modify by LiMing
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool Monitor::GetMonitorParaValueByName(string strName, string &strRet)
{
	OBJECT objMonitor = GetMonitor(m_MonitorID);
	if(objMonitor != INVALID_VALUE)
	{
		...
		{
			FindNodeValue(motnitornode, "sv_name", strRet);
